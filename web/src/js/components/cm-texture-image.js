...
class CmTextureImage extends HTMLElement {
	/**
	...
	constructor() {
		...
		img.className = styles['texture-image'];
	...
	set textureName(value) {
		...
		this.#imageEl.src = DATA_DIR + 'textures/' + value + '.png';
	}
...
customElements.define("cm-texture-image", CmTextureImage);